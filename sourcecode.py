...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  2 22:00:49 2018
...
c_val = get_counter('val/train1/')
c_train = get_counter('train/anpr_ocr/train/')
letters_train = set(c_train.keys())
letters_val = set(c_val.keys())
if letters_train == letters_val:
    print('Letters in train and val matches')
else:
    raise Exception()
...
tiger = TextImageGenerator('/val/train1/', 128, 64, 8, 4)
tiger.build_data()
...
#loss and train function and network architecture
...
def train(img_w, load=False):
    ...
    tiger_val = TextImageGenerator('/val/train/', img_w, img_h, batch_size, downsample_factor)
